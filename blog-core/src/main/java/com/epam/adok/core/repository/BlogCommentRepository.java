...
public interface BlogCommentRepository extends JpaRepository<BlogComment, Long> {
    ...
    @Query("SELECT comment FROM BlogComment comment WHERE comment.parentComment.id IS NULL ORDER BY comment.commentDate DESC")
    Page<BlogComment> findAllRootBlogCommentsByBlog(Blog blog, Pageable pageable);
